...
class DFA:
    ...
    def draw_nicely(self,force=False,maximum=60): #todo: if two edges are identical except for letter, merge them and note both the letters
        ...
        g = digraph()
        g.graph_attr.update({'fontname': 'Helvetica', 'fontsize': '20', 'rankdir': 'LR'})
        g.node_attr.update({'fontname': 'Helvetica', 'fontsize': '18'})
        g.edge_attr.update({'fontname': 'Helvetica', 'fontsize': '16'})
